        ...
        <div class="right-block">
          ...
          <div class="top-row">
            ...
            <div class="icon-group">
              <a href="#" class="icon-link wishlist">
                <ABaseIcon name="heart" size="19" />
              </a>
              <NuxtLink to="/login" class="icon-link account-link">
                <ABaseIcon name="user" size="19" />
              ...
              <div class="currency-wrapper" ref="currencyWrapper">
                <ABaseButton class="currency-btn" @click="isCurrencyOpen = !isCurrencyOpen">
                  ...
                  <ABaseIcon 
                    name="chevron-down" 
                    size="12" 
                    :style="{ transform: isCurrencyOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: '0.2s' }" 
                  />
                </ABaseButton>
      ...
      <div class="header-container nav-relative">
        <ul class="nav-list">
          ...
          <li class="has-mega-menu">
            <NuxtLink to="/shop" class="menu-link">Cubes</NuxtLink>
                   ...
                   <div class="mega-section" v-for="section in col" :key="section.title">
                    ...
                    <ul>
                      <li v-for="link in section.links" :key="link.text">
                        <NuxtLink :to="link.url.startsWith('/') ? link.url : '/shop'">{{ link.text }}</NuxtLink>
                      </li>
                    </ul>
                  </div>
                </div>
